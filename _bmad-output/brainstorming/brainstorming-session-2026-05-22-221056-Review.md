---
topic: 'Web-Anwendung zur Kapazitäts- und Bettenplanung für BAMF-Grenzverfahren (GEAS-Reform)'
goals: 'Funktionale Anforderungen, Nicht-funktionale Anforderungen (Barrierefreiheit/Sicherheit/DSGVO), Architekturentscheidungen, Grundanforderungen als nicht verhandelbare Leitplanken, Strategie für schnelle Umsetzung ohne Architekturschulden'
techniques_used: ['Question Storming', 'Six Thinking Hats', 'Constraint Mapping']
---

# Brainstorming Session Results

**Facilitator:** Berthold, Kausik
**Date:** 2026-05-22
...
- Zuständigkeit: BMI/BAMF (Rahmen) + Bundesländer (Umsetzung, z. B. Hessen/Bayern)
...
*Konzept:* PostgreSQL - Separate DB-Schemata: A zu zentraler BAMF-DB von Anfang an mitgedacht. Phase 1: DB-Administration via SQL, keine Admin-GUI.
...
*Entscheidung:* i18n und Konfigurations-Externalisierung vorbereiten aber noch nicht umsetzen.
